...
public class LectureReports extends AppCompatActivity implements ClickListenerInterface {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lecture_reports);
        init();
        fetchLectures();
    }
    ...
    void init()
    {
        ...
        prefManager = new PrefManager(LectureReports.this);
    }
        ...
        call.enqueue(new Callback<List<Lectures>>() {
            ...
            public void onResponse(Call<List<Lectures>> call, Response<List<Lectures>> response)
            {
                if(response.isSuccessful())
                {
                    ...
                    {
                        adp = new LectureAdapter(LectureReports.this,list,LectureReports.this);
            ...
            public void onFailure(Call<List<Lectures>> call, Throwable t) {
                ...
                Toast.makeText(LectureReports.this, ""+t.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    public void oniItemClick(int position) {
        Intent i = new Intent(LectureReports.this,Reports.class);
        i.putExtra("id",list.get(position).getId());
        i.putExtra("subject",list.get(position).getAssignsubject());
        i.putExtra("class",list.get(position).getAssignclass());
        startActivity(i);
    }
}